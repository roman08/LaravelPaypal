...
@section('descripcion')
	<img src="/img/planes/basico/basicodetalle.png" class="img-responsive" alt="" style="height: 100%; width: 100%;">
@stop


@section('logo')
	<img src="/img/planes/basico/basico.png" class="img-responsive" alt="Logo principal." style="height: 100%;
      width: 400%;">
@stop
    ...
    <div class="feature-info">
      <div class="fea">
        <div class="col-md-6">
          ...
          <div class="fea-img pull-left">
            <img src="/img/planes/iconosDetalle/geolocalization.png" class="img-responsive" alt="" style="height: 50%;
      width: 50%;">
          </div>
        </div>
      </div>
      <div class="fea">
        <div class="col-md-6">
          ...
          <div class="fea-img pull-left">
            <img src="/img/planes/iconosDetalle/online-shop.png" class="img-responsive" alt="" style="height: 50%;
      width: 50%;">
          </div>
        </div>
      </div>      
