{{ Form::open( ['route' => ['sucursales.update', $sucursal->idsucursal], 'method'=>'PUT']) }}

<div class="row">
    <div class="form-group col-md-12">
        {!!Form::label('nombre','Nombre de la sucursal')!!}
        {!!Form::text('nombre', $sucursal->sucursal,['class'=>'form-control','placeholder'=>'Nombre sucursal', 'autocomplete'=>'off'])!!}
    </div>
</div>
<div class="row">
    <div class="form-group col-md-12">
        {!!Form::label('telefono','Teléfono')!!}
        {!!Form::text('telefono', $sucursal->telefono,['class'=>'form-control','placeholder'=>'Teléfono', 'autocomplete'=>'off'])!!}
    </div>
</div>
<div class="row">
    <div class="form-group col-md-12 radio-buttons">
        {{ Form::checkbox('entrega', null,  $sucursal->entrega )}}
                        ...
                        <div class="form-group col-md-10">
                            ...
                            <div class="col-md-3">
                                {!!Form::label('numero','Número')!!}
                                    {!!Form::text('numero',isset($secciones)?$secciones[1]:null,
                                        [
                                            'class'=>'form-control',
                                            'id' => 'numero', 
                                            'autocomplete'=>'off', 
                            ...
                            <div class="col-md-3">
                                {!!Form::label('interior',' Interior')!!}
                                    {!!Form::text('interior',isset($secciones)?$secciones[2]:null,
                                        [
                                            'class'=>'form-control',
                                            'id' => 'interior',  
                                            'autocomplete'=>'off', 
                            ...
                            <div class="col-md-6">
                                {!!Form::label('colonia','Colonia')!!}
                                    {!!Form::text('colonia',isset($secciones)?$secciones[3]:null,
                                        [
                                            'class'=>'form-control',
                                            'id' => 'colonia',  
                                            'autocomplete'=>'off', 
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="idmunicipio" id="idmunicipio" class="form-control" required>
                                    ...
                                    @foreach($municipios as $key => $p)
                                        <option value="{{$key}}" @if( $sucursal->idmunicipio ==$key )  selected @endif >{{$p}}</option>
                                    @endforeach
                                </select>
                            </div>
                            {{ Form::hidden('lat',$sucursal->latitud,['id' =>'lat']) }}
                            {{ Form::hidden('lng',$sucursal->longitud,['id' =>'lng']) }}
                            {{ Form::hidden('municipio',$secciones[5],['id' =>'municipio']) }}
